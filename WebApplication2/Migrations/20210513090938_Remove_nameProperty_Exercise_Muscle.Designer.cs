...
namespace PersonalTrainerApp.Migrations
{
    ...
    [Migration("20210513090938_Remove_nameProperty_Exercise_Muscle")]
    partial class Remove_nameProperty_Exercise_Muscle
    {
            ...
            modelBuilder.Entity("PersonalTrainerApp.Models.Exercise_Muscle", b =>
                {
                    ...
                    b.HasOne("PersonalTrainerApp.Models.Muscle", "muscles")
                        .WithMany("exerciseMuscles")
                        .HasForeignKey("musclesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
