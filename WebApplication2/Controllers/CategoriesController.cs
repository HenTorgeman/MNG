...
namespace PersonalTrainerApp.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(app_context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,name,hebrewName")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,name,hebrewName")] Category category)
        {
            if (id != category.id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> UploadFile(UploadDataFiles_ViewModel vm)
        {
            ...
            {
                Category c = new Category(dt.Rows[i]);
